...
@views function MainStokes2D()
    ...
    if PC 
        DiagMechanics2Dx!( Dx, ηc_minloc, ηb, ηv_minloc, Δx, Δy, bx, Ncx, Ncy )
        DiagMechanics2Dy!( Dy, ηc_minloc, ηb, ηv_minloc, Δx, Δy, by, Ncx, Ncy )
    end
    ...
    for it=1:Nt
        ...
        @time @views for iter=1:niter
            ...
            if mod(iter, nout) == 0 || iter==1
                ...
                ResidualMomentumX!(KδVx1, Vx,      Vy,      Pt, bx, ε̇xx, ε̇xy, ∇v, ηc, ηb, ηv, Dx, τxx, τxy, Δx, Δy, 0.0)
