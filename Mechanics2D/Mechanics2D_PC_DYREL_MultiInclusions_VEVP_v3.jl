...
# The yield function is solved iteratively
...
@views function VEP(ϵ̇xx, ϵ̇yy, ϵ̇xy, ϵ̇zz, params, ηv, ηe, λ̇it, Fc)
    rel           = params.pl.rel
...
@views function Stress!(τ, τ0, Pt, ε̇, rheo, params, Δt)
    for i in eachindex(τ.xx)
        ...
        ϵ̇zz           = -(ϵ̇xx + ϵ̇yy)
        ηeff, τxx, τyy, τxy, F, λ̇it = VEP(ϵ̇xx, ϵ̇yy, ϵ̇xy, ϵ̇zz, params, ηv, ηe, λ̇it, F)
        #------------ update
        rheo.Fc[i]   = F
        rheo.λ̇c[i]    = λ̇it
        τ.xx[i]       = τxx
